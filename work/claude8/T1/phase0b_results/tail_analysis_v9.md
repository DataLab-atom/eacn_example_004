...
| 12q_3x4_scrambled_d=6_LC-edge(q0,q4,d=2) | 1908 | 24.66% | 90.34% | 99.66% | 6/12 | 100.00% | exp R²=0.491 / pow R²=0.222 |
| 12q_3x4_scrambled_d=8_LC-edge(q0,q4,d=2) [TOP-500 of 46665] | 500 | 19.28% | 68.27% | 94.73% | 3/12 | 56.21% | exp R²=0.889 / pow R²=0.989 |
...
### 12q_3x4_scrambled_d=6_LC-edge(q0,q4,d=2)
- terms: 1908 (expected 1908)
- total norm Σ|c|²: 0.966591
- cumulative coverage: top-1 24.66%, top-10 90.34%, top-100 99.66%, top-1% (k=19) 96.55%
- per-qubit support count: [1532, 1128, 0, 0, 1128, 1128, 0, 0, 1128, 1128, 0, 0]
- hot sites (count ≥ 50% of max site count): [0, 1, 4, 5, 8, 9] (6/12) carrying 100.00% of total support count
- tail fit (skip top-5): log|c|² ~ exp slope=-0.149 (R²=0.491); log|c|² ~ pow slope=-134 (R²=0.222) → **tail = EXPONENTIAL**

### 12q_3x4_scrambled_d=8_LC-edge(q0,q4,d=2) [TOP-500 of 46665]
- terms: 500 (expected 500)
- total norm Σ|c|²: 0.0572096
- cumulative coverage: top-1 19.28%, top-10 68.27%, top-100 94.73%, top-1% (k=5) 55.77%
- per-qubit support count: [449, 402, 181, 11, 41, 73, 362, 6, 105, 155, 155, 218]
- hot sites (count ≥ 50% of max site count): [0, 1, 6] (3/12) carrying 56.21% of total support count
- tail fit (skip top-5): log|c|² ~ exp slope=-0.00446 (R²=0.889); log|c|² ~ pow slope=-1.76 (R²=0.989) → **tail = POWER-LAW**
