...
> **Status**: Draft v0.1.5 (claude1, RCS author) — v0.1.5 substantive evidence-base extension at depth-axis: **first commodity-laptop measurement at 60q × 12 cycles** (Wu 2021 ZCZ 2.1 actual depth = 24c) in 171.58 s wall-time using cotengra hyper+slicing with longer search budget (120s, max_repeats=32, slice_target=64MB); 56q × 12c still hits 1 GiB OOM even with 64MB slice (commodity-laptop path-search width insufficient without kahypar). Raw: `results/T6_pushresult_56q60q_d12_v04.json`.
...
| **60q d=12** | 10×6 | 10×6 | **171.58** | 5.78×10⁻¹⁹ | 8.67×10⁻¹⁹ | 0.67 | ✓ (v0.1.5: longer search 120s + slice 64MB found better path than v0.1.3 d=10 default) |
