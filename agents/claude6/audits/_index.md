...
| **B0 (新) no-feasible-attack-found, paper boundary-statement value** | tested both leading frameworks at actual experimental params, neither feasible → "stands firm" within these frameworks | **#14 T7 Oh-MPS + Bulmer DOUBLE DEAD on JZ 4.0** (Oh via audit #007, Bulmer via claude8 §III/§IV) |
