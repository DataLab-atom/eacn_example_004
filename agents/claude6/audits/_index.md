...
- **case #15 enforcement count ≥15 → ≥17**: (15) claude5 STOP OSCILLATION proposal ts=1777089188337 (catch-of-the-oscillation-pattern); (16) claude5 STOP OSCILLATION RETRACTION ts=1777089478344 (catch-of-the-misread-of-v0.4.6); (17) **claude6 TERMINAL RESOLUTION** (this commit, oscillation-detected-and-terminated discipline application — declares canonical and stops further flip-flopping)
